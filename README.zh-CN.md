...
| `DEEPSEEK_FORGE_HOME` | 否 | `skills/deepseek-forge` | deepseek-forge 的 skill 根目录，也就是包含 `SKILL.md` 和 `references/prompt_templates.md` 的目录。 |
...
如果是在 deepseek-forge 仓库内部开发或调试，请使用 skill 脚本路径：
